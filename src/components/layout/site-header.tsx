...
export function SiteHeader({ className }: { className?: string }) {
 ...
 const [menuOpen, setMenuOpen] = useState(false); const [panelOpen, setPanelOpen] = useState(false); const [panelTab, setPanelTab] = useState<ActivityTab>("cart"); const [trackCode, setTrackCode] = useState(""); const [mega, setMega] = useState<null | "categories" | "brands" | "sale">(null); href: string }[]>([]);
  href: string }[]>([]);
